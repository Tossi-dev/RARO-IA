...
powershell -NoProfile -ExecutionPolicy Bypass -File "C:\dev\Repositorios\RARO IA\rodar-simulacao.ps1"
echo.
echo ================================================================
echo  Terminou. A saida completa esta em simulacao-saida.txt
echo ================================================================
pause
