-- ============================================================
-- 0036 — correção do vínculo sessão ↔ mentorado em análises internas
--
-- 0033 validava uma coluna inexistente em sessao. A sessão se vincula ao
-- mentorado pela matrícula direta ou pelas matrículas da turma; os dois
-- caminhos precisam pertencer ao mesmo workspace da análise.
-- ============================================================
